...
const MOCK_CONTAINERS = [
  { id: "a1b2c3d4", name: "nginx-proxy", image: "nginx:alpine", status: "running", cpu: 2.3, mem: 45, memMb: 128, uptime: "4d 12h 33m", ports: "80:80, 443:443", health: "healthy" },
  ...
  { id: "i9j0k1l2", name: "redis-cache", image: "redis:7-alpine", status: "running", cpu: 0.8, mem: 12, memMb: 64, uptime: "4d 12h 31m", ports: "6379:6379", health: "healthy" },
  ...
  { id: "u1v2w3x4", name: "etl-pipeline", image: "gowombat/etl:2.1", status: "running", cpu: 15.6, mem: 45, memMb: 384, uptime: "1d 3h", ports: "-", health: "healthy" },
  { id: "y5z6a7b8", name: "web-app-frontend", image: "node:20-slim", status: "running", cpu: 1.1, mem: 18, memMb: 156, uptime: "4d 12h 33m", ports: "3000:3000", health: "healthy" },
  { id: "c9d0e1f2", name: "portainer-agent", image: "portainer/agent:latest", status: "running", cpu: 0.3, mem: 5, memMb: 32, uptime: "4d 12h 33m", ports: "9001:9001", health: "healthy" },
...
const MOCK_LOGS = [
  { time: "14:23:01", level: "INFO", source: "SYSTEM", msg: "Container health check cycle completed — 9/10 operational" },
  { time: "14:22:58", level: "ERR", source: "scraper-worker-2", msg: "FATAL: OOMKilled — container exceeded memory limit (1024MB)" },
  ...
  { time: "14:22:45", level: "INFO", source: "scraper-worker-1", msg: "Batch 203/500 completed — 1,247 records extracted" },
  { time: "14:22:30", level: "INFO", source: "etl-pipeline", msg: "Transform stage: processing 12,847 records from staging" },
  { time: "14:21:15", level: "WARN", source: "postgres-main", msg: "Connection pool at 78% capacity (156/200 connections)" },
  { time: "14:20:02", level: "INFO", source: "watchtower", msg: "Checking for image updates... all images up to date" },
  { time: "14:19:44", level: "INFO", source: "nginx-proxy", msg: "GET /api/v1/health 200 — 2ms" },
  { time: "14:18:30", level: "INFO", source: "uptime-kuma", msg: "All 14 monitors operational — avg response 43ms" },
  { time: "14:17:00", level: "INFO", source: "SYSTEM", msg: "Disk usage: 47% (234GB/500GB) — Volume cleanup not required" },
  { time: "14:16:22", level: "ERR", source: "etl-pipeline", msg: "Failed to parse row 4,231 — invalid UTF-8 sequence in field 'description'" },
  { time: "14:15:10", level: "WARN", source: "redis-cache", msg: "Memory usage approaching maxmemory limit (58MB/64MB)" },
  { time: "14:14:55", level: "INFO", source: "nginx-proxy", msg: "POST /api/v1/scrape 201 — 142ms" },
  { time: "14:14:01", level: "INFO", source: "scraper-worker-1", msg: "Batch 202/500 completed — 1,193 records extracted" },
  { time: "14:13:30", level: "ERR", source: "web-app-frontend", msg: "Unhandled promise rejection: TypeError: Cannot read property 'map' of undefined at Dashboard.jsx:47" },
  { time: "14:12:44", level: "WARN", source: "postgres-main", msg: "Slow query detected: SELECT * FROM events WHERE... (3,412ms)" },
...
function ContainerRow({ container, selected, onClick }) {
  ...
  return (
    <div
      ...
      onMouseLeave={e => { if (!selected) e.currentTarget.style.background = selected ? "rgba(0,255,65,0.1)" : "transparent"; }}
    >
...
export default function DockerDashboard() {
  ...
  const tabs = ["CONTAINERS", "LOGS", "AI AGENT", "STACKS", "SYSTEM"];
  ...
  if (!bootDone) {
    const bootLines = [
      ...
      "LOADING CONTAINER MANIFESTS ... [OK]",
    ...
    <div style={{
      ...
      <div style={{
        ...
        {[
          ...
          { label: "CONTAINERS", value: `${MOCK_CONTAINERS.length}`, sub: `${runningCount} active` },
          { label: "DISK I/O", value: "234GB", sub: "/ 500GB (47%)" },
        ].map((stat, i) => (
      ...
      <div style={{ display: "flex", height: "calc(100vh - 170px)" }}>
        ...
        <div style={{ flex: 1, borderRight: "1px solid #004d14", display: "flex", flexDirection: "column" }}>
          ...
          {activeTab === "CONTAINERS" && (
            <>
              <div style={{
                ...
                <span></span><span>NAME</span><span>IMAGE</span><span>STATE</span><span>CPU</span><span>MEMORY</span><span>UPTIME</span>
              </div>
              <div style={{ flex: 1, overflow: "auto" }}>
                {MOCK_CONTAINERS.map((c, i) => (
                  <div key={c.id} style={{ animation: `fadeIn 0.3s ease ${i * 0.04}s both` }}>
                    <ContainerRow
                      container={c}
          ...
          {(activeTab === "STACKS" || activeTab === "SYSTEM") && (
            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", color: "#007a22", fontSize: 13 }}>
